...
Route::get('/applications/job-listings/{job_listings_id}', [ApplicationController::class, 'getJobApplications'])->middleware('auth:sanctum');
Route::get('/applications/users/{user_id}', [ApplicationController::class, 'getUserApplications'])->middleware('auth:sanctum');
